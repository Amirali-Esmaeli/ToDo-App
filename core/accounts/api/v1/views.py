...
from .seializers import (RegistrationSerializer,CustomAuthTokenSerializer,
                         CustomTokenObtainPairViewSerializer, ActivationResendSerializer,
                         ChangePasswordSerializer,PasswordResetRequestViewSerializer,
